...
export const translations = {
  en: {
    ...
    update: {
      ...
      engineTitle: "Aether Engine",
      guiTitle: "Aether-GUI",
      current: "Current",
      latest: "Latest",
      published: "Published",
      available: "A newer release is available.",
      upToDate: "You've seen the latest release.",
      unknown: "Couldn't check yet.",
      noReleases: "No release published yet.",
      checking: "Checking…",
      checkNow: "Check now",
  ...
  fa: {
    ...
    update: {
      toggle: "بررسی آپدیت",
      engineTitle: "هسته‌ی Aether",
      guiTitle: "Aether-GUI",
      current: "نسخه‌ی فعلی",
      latest: "آخرین نسخه",
      published: "تاریخ انتشار",
      available: "نسخه‌ی جدیدتری منتشر شده.",
      upToDate: "آخرین نسخه رو دیدی.",
      unknown: "هنوز چک نشده.",
      noReleases: "هنوز ریلیزی منتشر نشده.",
      checking: "در حال بررسی…",
      checkNow: "بررسی الان",
      viewRelease: "مشاهده‌ی ریلیز",
    },
    connectButton: {
      connect: "اتصال",
